    ...
    TimeGridEventRenderer.prototype.fgSegHtml = function (seg, disableResizing) {
        ...
        return '<a class="' + classes.join(' ') + '"' +
            ...
            (skinCss ?
                ...
                '') +
            '>' +
            '<div class="fc-content 1 ical-src-' + eventDef.source.uid + '">' +
            (timeText ?
                '<div class="fc-time"' +
            ...
            (eventDef.title ?
                ...
                '') +
            '</div>' +
            '<div class="fc-bg ical-src-' + eventDef.source.uid + '"></div>' +
    ...
    DayGridEventRenderer.prototype.fgSegHtml = function (seg, disableResizing) {
        ...
        return '<a class="' + classes.join(' ') + '"' +
            ...
            (skinCss ?
                ...
                '') +
            '>' +
            '<div class="fc-content 2 ical-src-' + eventDef.source.uid + '">' +
            (this.dayGrid.isRTL ?
